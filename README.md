...
`Simpul awal dimasukkan ke dalam antrian.`

`Simpul paling depan diambil dan dicetak.`

`Tetangga yang belum dikunjungi dimasukkan ke antrian.`

BFS menelusuri graf secara bertingkat dari simpul terdekat ke simpul yang lebih jauh.
##### 6. Pembuatan Objek Graph

`Graf dibuat dengan 4 simpul.`

`Beberapa sisi ditambahkan untuk membentuk hubungan antar simpul.`

`Relasi ini membentuk graf tidak berarah.`
##### 7. Proses Traversal

`DFS dijalankan terlebih dahulu dari simpul 0.`

`BFS dijalankan setelahnya dari simpul 0.`

`Hasil traversal ditampilkan ke layar untuk memperlihatkan perbedaan cara kerja DFS dan BFS.`
______________________________________________________________________________________________________

Program ini menunjukkan bagaimana sebuah graf dapat dibangun menggunakan adjacency list serta bagaimana dua algoritma penting, DFS dan BFS, dapat digunakan untuk menelusuri setiap simpul dalam graf dengan cara yang berbeda. DFS fokus pada kedalaman, sedangkan BFS fokus pada lebar atau tingkat simpul.
